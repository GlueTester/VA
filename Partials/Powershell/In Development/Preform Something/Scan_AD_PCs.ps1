...
$OUComputerList=(Get-ADComputer -Filter 'Name -like "LEX-*"' -SearchBase $OU -Properties Name| Select-Object Name).Name
...
Write-Host $Monitor_Array
$Monitor_Array | export-csv -Path "$SaveDir\MonitorScan_$CurrentDate.csv" -NoTypeInformation -Append | Select-Object -Skip 1
