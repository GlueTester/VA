...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.switch_extended = customtkinter.CTkSwitch(self, text=f"Extended Search")
        self.switch_extended.grid(row=3, column=3 , padx=(20, 0), pady=(20, 10), sticky="nsew")
        self.progressbar_4 = customtkinter.CTkProgressBar(self,width=90, height=10)
        self.progressbar_4.grid(row=4, column=1, padx=(20, 10), pady=(1, 10), sticky="ew")
        ...
        self.tabview.tab("Computer").grid_columnconfigure(0, weight=1)  # configure grid of individual tabs
        self.tabview.tab("User").grid_columnconfigure(0, weight=1)
        self.tabview.tab("Printer").grid_columnconfigure(0, weight=1)
        self.tabview.tab("Vista").grid_columnconfigure(0, weight=1)
        ...
        self.progressbar_4.configure(mode="indeterminnate")
        
        self.textbox.insert("0.0", "Output/Log Box\n\n" + "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)
