f12_key_press_count = 100 #equal 162 seconds
enter_key_press_count = 1 #was 15 # equals 30secs of pressing enter
...
first_key_press = KeyPress(f12)+ postkey
first_repeat_press= KeyPress(f12)+ postkey

second_key_press = KeyPress(enter)+ postkey
second_repeat_press= KeyPress(enter)+ postkey

PreSeq = KeyPress(tab)+ postkey + KeyPress(tab)+ postkey + KeyPress(tab)+ postkey + KeyPress(tab)+ postkey + KeyPress(tab)+ postkey + KeyPress(enter)+ postkey + KeyPress(downarrow) + postkey + KeyPress(downarrow) + postkey + KeyPress(enter)
Seq1 = KeyPress(f12) + postkey + first_repeat_press*f12_key_press_count
Seq2 = second_key_press + second_repeat_press*enter_key_press_count + KeyPress(enter) #last key press is to negate last key_sperator
AllFields = Seq1 + Seq2
print (f"{pre_virt_sequence}\"{AllFields}\"{post_virt}")


#OSD IMage selection
#tab,500,tab,500,spacebar
#down*11 -enter
